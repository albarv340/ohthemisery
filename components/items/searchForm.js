...
const sortableStats = ["-", "Abyssal", "Adaptability", "Adrenaline", "Agility", "Anemia", "Aptitude", "Aqua Affinity", "Arcane Thrust", "Armor", "Ashes of Eternity", "Attack Damage Percent", "Attack Speed Flat", "Attack Speed Percent", "Attack Damage Base", "Attack Speed Base", "Projectile Damage Base", "Projectile Speed Base", "Spell Power Base", "Throw Rate Base", "Throw Rate Percent", "Blast Prot", "Bleeding", "Chaotic", "Corruption", "Crippling", "Darksight", "Decay", "Depth Strider", "Duelist", "Efficiency", "Eruption", "Ethereal", "Evasion", "Feather Falling", "Fire Aspect M", "Fire Aspect P", "Fire Prot", "Fortune", "Gills", "Hex Eater", "Ice Aspect M", "Ice Aspect P", "Ineptitude", "Inferno", "Infinity Bow", "Infinity Tool", "Intuition", "Inure", "Irreparability", "Knockback", "Knockback Resistance Flat", "Life Drain", "Looting", "Lure", "Magic Damage Percent", "Magic Prot", "Max Health Flat", "Max Health Percent", "Melee Prot", "Mending", "Multishot", "Multitool", "Piercing", "Point Blank", "Poise", "Projectile Damage Percent", "Projectile Speed Percent", "Projectile Prot", "Protection of the Depths", "Punch", "Quake", "Quick Charge", "Radiant", "Rage of the Keter", "Recoil", "Reflexes", "Regen", "Regicide", "Respiration", "Resurrection", "Retrieval", "Riptide", "Sapper", "Second Wind", "Shielding", "Shrapnel", "Silk Touch", "Slayer", "Smite", "Sniper", "Soul Speed", "Speed Flat", "Speed Percent", "Steadfast", "Sustenance", "Sweeping Edge", "Tempo", "Thorns Flat", "Thorns Percent", "Thunder Aspect M", "Thunder Aspect P", "Triage", "Two Handed", "Unbreakable", "Unbreaking", "Vanishing", "Weightless"]
